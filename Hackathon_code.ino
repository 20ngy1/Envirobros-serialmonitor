...
void loop() {
  ...
  float voltage = conductivityReading*(5.0/1023.0)-1.70-0.24-0.3; //put the data in terms of voltage used(5 volts)
  float temperature = ((tempReading)-273-32)*5/9-19;

  Serial.println("Voltage:   " + String(voltage)+"         " + "Temperature:   " + String(temperature)); //print the current reading to the serial part 
